...
files=dir('./08.WGCNA/venn/')    #获取目录下所有文件
...
pdf(file='./08.WGCNA/venn/venn.pdf', width=5, height=5)
grid.draw(venn.plot)
dev.off()

intersectGenes=Reduce(intersect,geneList)
write.table(file='./08.WGCNA/venn/intersect.txt',intersectGenes,sep="\t",quote=F,col.names=F,row.names=F)
