...
p0 <- ggplot(mydata,aes(x= UMAP_1 , y = UMAP_2 ,color = Sample)) +geom_point(size = 1 , alpha =1 )+
...
ggsave('./03.Harmony/harmony_befor.pdf',p0,width =12,height = 8,dpi = 1000 )
ggsave('./03.Harmony/harmony_befor.jpg',p0,width =12,height = 8,dpi = 1000 )
...
p15 <- p0|p13+plot_layout(guides = 'collect')
ggsave('./03.Harmony/harmony_all.pdf',p15,width =24,height = 8,dpi = 1000 )
ggsave('./03.Harmony/harmony_all.jpg',p15,width =24,height = 8,dpi = 1000 )
