...
files=c("./00.data/COAD/01.TCGA/TCGA.TPM.txt", "./00.data/COAD/02.GSE39582/GSE39582.txt",
        "./00.data/COAD/03.GSE17538/GSE17538.txt")
geneList=list()
...
write.table(outTab, file="./00.data/COAD/04.meger/merge.txt", sep="\t", quote=F, col.names=F)
...
write.table(tpmOut, file="./00.data/COAD/04.meger/m6A_merge.txt", sep="\t", col.names=F, quote=F)
