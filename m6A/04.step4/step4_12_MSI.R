...
scoreFile="./00.data/COAD/11.Model/m6Ascore_train_group.txt"    
cliFile="./00.data/COAD/12.MSI/MSI.txt"                 
x <- "./04.step4/11.MSI/barplot.pdf"
y <- "./04.step4/11.MSI/barplot.jpg"
z <- "./04.step4/11.MSI/boxplot.pdf"
a <- "./04.step4/11.MSI/boxplot.jpg"
