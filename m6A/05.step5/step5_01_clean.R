...
files=c("./00.data/READ/01.TCGA/TCGA.TPM.txt", "./00.data/READ/02.GSE17536/GSE17536.txt",
        "./00.data/READ/03.GSE17537/GSE17537.txt")
geneList=list()
...
write.table(outTab, file="./00.data/READ/04.meger/merge.txt", sep="\t", quote=F, col.names=F)
...
write.table(tpmOut, file="./00.data/READ/04.meger/m6A_merge.txt", sep="\t", col.names=F, quote=F)
