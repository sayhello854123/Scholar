...
##merge
if(T){
  files=c("./00.data/ESCA/02.GSE53625/GSE53622.txt", "./00.data/ESCA/02.GSE53625/GSE53624.txt",
          "./00.data/ESCA/01.TCGA/TCGA.TPM.txt"
          )
  geneList=list()
  ...
  write.table(outTab1, file="./00.data/ESCA/04.meger/merge.txt", sep="\t", quote=F, col.names=F)
  ...
  write.table(tpmOut, file="./00.data/ESCA/04.meger/m6A_merge.txt", sep="\t", col.names=F, quote=F)
}
