...
##merge
if(T){
files=c("./00.data/PAAD/02.GSE62452/GSE62452.txt", "./00.data/PAAD/01.TCGA/TCGA.TPM.txt",
        "./00.data/PAAD/03.GSE79668/GSE79668.txt")
geneList=list()
...
write.table(outTab1, file="./00.data/PAAD/04.meger/merge.txt", sep="\t", quote=F, col.names=F)
...
write.table(tpmOut, file="./00.data/PAAD/04.meger/m6A_merge.txt", sep="\t", col.names=F, quote=F)
}
