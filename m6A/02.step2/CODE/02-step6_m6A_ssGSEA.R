...
if(T){
  ...
  write.table(ssgseaOut,file="./00.data/PAAD/07.GSVA/ssGSEA.result.txt",sep="\t",quote=F,col.names=F)
  ...
  ggsave(filename = "./02.step2/05.PAAD_ssGSEA/metabolize_boxplot.pdf",plot =plot2,
         width=8, height=6.5,dpi = 1000)
  ggsave(filename = "./02.step2/05.PAAD_ssGSEA/metabolize_boxplot.jpg",plot =plot2,
         width=8, height=6.5,dpi = 1000)
