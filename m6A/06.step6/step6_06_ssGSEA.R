...
if(T){
  ...
  write.table(ssgseaOut,file="./00.data/STAD/07.GSVA/ssGSEA.result.txt",sep="\t",quote=F,col.names=F)
  ...
  ggsave(filename = "./06.step6/05.ssGSEA/metabolize_boxplot.pdf",plot =plot2,
         width=8, height=6.5,dpi = 1000)
  ggsave(filename = "./06.step6/05.ssGSEA/metabolize_boxplot.jpg",plot =plot2,
         width=8, height=6.5,dpi = 1000)
