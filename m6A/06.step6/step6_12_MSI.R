...
scoreFile="./00.data/STAD/11.Model/m6Ascore_train_group.txt"    
cliFile="./00.data/STAD/12.MSI/MSI.txt"                 
x <- "./06.step6/11.MSI/barplot.pdf"
y <- "./06.step6/11.MSI/barplot.jpg"
z <- "./06.step6/11.MSI/boxplot.pdf"
a <- "./06.step6/11.MSI/boxplot.jpg"
