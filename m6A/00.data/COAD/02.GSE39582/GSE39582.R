...
write.table(outTab, file="./00.data/COAD/02.GSE39582/GSE39582.txt", sep="\t", quote=F, col.names=F)
outTab1=rbind(id_name=colnames(clinical), clinical)
write.table(outTab1, file="./00.data/COAD/02.GSE39582/clinical.txt", sep="\t", quote=F, col.names=F)
